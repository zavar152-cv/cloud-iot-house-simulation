...
public class ExampleJava {
    ...
    private final String deviceID = "areom5ojjdknaaofng59";

    // Needed only for login with password:
    private final String devicePassword = "Password_Password_0";
    private final String registryID = "arer55oi4m3l1tv2r7ig";
    private final String regPassword = "Password_Password_1";
